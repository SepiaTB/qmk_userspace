...
enum custom_keycodes {
    ...
    HIRAGANA,
    KATAKANA,
    // Add space for keyboard-specific keycodes
    SEPIA_SAFE_RANGE,
};
...
// Define shared keymaps using macros that can be used by both keyboards
#define SEPIA_LAYOUT_QWERTY() \
